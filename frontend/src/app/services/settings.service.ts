...
const TRANSLATIONS: Dictionary = {
  ...
  "income.deleteModalTitle": { es: "Eliminar ingreso", en: "Delete income" },
  "income.deleteModalText": { es: "Esta acción no se puede deshacer.", en: "This action cannot be undone." },
  "income.confirmDelete": { es: "Sí, eliminar", en: "Yes, delete" },
  ...
  "category.search": { es: "Buscar categorías...", en: "Search categories..." },
  "category.all": { es: "Todas", en: "All" },
  "category.sort": { es: "Ordenar", en: "Sort" },
  "category.sortRecent": { es: "Más recientes", en: "Most recent" },
  "category.sortNameAsc": { es: "Nombre (A-Z)", en: "Name (A-Z)" },
  "category.sortNameDesc": { es: "Nombre (Z-A)", en: "Name (Z-A)" },
  "category.duplicate": { es: "Duplicar", en: "Duplicate" },
  "category.uses": { es: "usos", en: "uses" },
  "category.noResults": { es: "No se encontraron categorías", en: "No categories found" },
  "category.noResultsHint": { es: "Ajusta la búsqueda o el filtro", en: "Adjust your search or filter" },
  "category.deleteModalTitle": { es: "Eliminar categoría", en: "Delete category" },
  "category.deleteModalText": { es: "Esta acción no se puede deshacer.", en: "This action cannot be undone." },
  "category.confirmDelete": { es: "Sí, eliminar", en: "Yes, delete" },
  "category.pin": { es: "Fijar categoría", en: "Pin category" },
  "category.unpin": { es: "Desfijar categoría", en: "Unpin category" },
  "category.topBySpending": { es: "Mayor gasto por categoría", en: "Top spending by category" },
  "category.topNone": { es: "Aún no hay gastos para mostrar", en: "No spending data yet" },
  "category.cantDeleteInUse": { es: "No se puede eliminar: esta categoría está en uso.", en: "Cannot delete: this category is in use." },
  ...
  "expense.deleteModalTitle": { es: "Eliminar gasto", en: "Delete expense" },
  "expense.deleteModalText": { es: "Esta acción no se puede deshacer.", en: "This action cannot be undone." },
  "expense.confirmDelete": { es: "Sí, eliminar", en: "Yes, delete" },
